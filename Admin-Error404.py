...
slowprint("\033[1;31m             ███████╗██║  ██║██║  ██║╚██████╔╝██║  ██║         ██║╚██████╔╝     ██║")
slowprint("\033[1;31m             ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝         ╚═╝ ╚═════╝      ╚═╝")
slowprint("                                                                      |ADMIN-FINDER|")
 
   


slowprint("[Error 404] :  HTTP y HTTPS [http://www.webscantest.com/] ~ [https://webscantest.com/] ")

url = input("\033[1;31m Website : ")
print("")
print ("Analizando : ")

print("                                                                                        ")

passe = ('admin/','administrator/','wp-login.php','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for hani in passe :
    ...
    try :
        ...
        print("\033[;36m" + " ADMIN PAGE ITS FOUND : "+curl)
        
     

    except urllib.error.URLError as msg :

        print ("\033[1;31m  ERROR 404 NOT FOUND : "+curl)
print("ERROR404")
